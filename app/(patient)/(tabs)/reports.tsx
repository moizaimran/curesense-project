        ...
        {sessions.length === 0 && !error && (
          <View style={s.emptyState}>
            ...
            <Text style={s.emptySub}>
              Complete an AI interview to see your reports here.
            </Text>
          </View>
        )}
            ...
            {active.map((sess) => (
              <View key={sess._id} style={s.card}>
                <View style={s.cardHeader}>
                  ...
                  >
                    <Text style={[s.statusBadgeText, { color: "#FBBF24" }]}>
                      In Progress
                    </Text>
                  </View>
                  <TouchableOpacity
                ...
                <Text style={s.cardSub}>
                  {sess.turn_count} question{sess.turn_count !== 1 ? "s" : ""}{" "}
                  completed
                </Text>
                <View style={s.cardFooter}>
                  <Ionicons name="time-outline" size={13} color="#FBBF24" />
                  <Text style={[s.cardFooterText, { color: "#FCD34D" }]}>
            ...
            {expired.map((sess) => (
              <View key={sess._id} style={[s.card, s.cardExpired]}>
                <View style={s.cardHeader}>
                  ...
                  <Text style={[s.cardDate, s.textMuted]}>
...
const s = StyleSheet.create({
  ...
  completedCard: {
    ...
    borderLeftWidth: 3,
    borderLeftColor: "rgba(34,197,94,0.50)",
    gap: 6,
  },
