...
export default function LoginScreen() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      await SecureStore.setItemAsync('patient_id', data.user.patient_id?.toString() ?? '');
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={s.sub}>Sign in to continue to your health dashboard.</Text>
          ...
          <View style={s.form}>
            ...
            <TouchableOpacity style={[s.btnPrimary, loading && { opacity: 0.6 }]} onPress={handleLogin} activeOpacity={0.85} disabled={loading}>
...
const s = StyleSheet.create({
  ...
  sub:          { color: 'rgba(255,255,255,0.60)', fontSize: 14, marginBottom: 32, lineHeight: 22 },
  ...
  btnOutline:     { borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.25)', borderRadius: 12, paddingVertical: 15, alignItems: 'center', marginBottom: 24 },
